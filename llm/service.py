...
async def build_subscription_digest(
    *,
    ...
    system_prompt = (
        ...
        "- If NOTHING in this window is relevant to the user's query, do not "
        "pad with off-topic items. Output a short note that there were no "
        "relevant updates in this period, and set a low confidence.\n\n"
